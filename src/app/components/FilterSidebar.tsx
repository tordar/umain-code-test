...
export default function FilterSidebar({ filters }: FilterSidebarProps) {
    ...
    // Continue improving styling for the filter chips - especially spacing
    // Conditional rendering for the filter on mobile
    // Begin work on the actual filtering logic
    
    return (
        <div className="bg-white shadow rounded-lg p-4" style={{ width: '239px'}}>
